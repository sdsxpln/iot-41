...
TEST(Math, Rotation) {
	static const struct {
		...
		int16_t dv;
		  ...
		  { 0 * Table::pi() / 2,  0 * 256 + 128,  0 * 256 + 128,  256,    0 }
		, { 1 * Table::pi() / 2, 95 * 256 + 128,  0 * 256 + 128,    0,  256 }
		, { 2 * Table::pi() / 2, 95 * 256 + 128, 95 * 256 + 128, -256,    0 }
		, { 3 * Table::pi() / 2,  0 * 256 + 128, 95 * 256 + 128,    0, -256 }
	};
